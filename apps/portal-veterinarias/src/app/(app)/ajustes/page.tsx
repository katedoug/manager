...
function TabPerfil() {
  ...
  const form = useForm<z.infer<typeof profileSchema>>({
    ...
    defaultValues: { firstName: "", lastName: "", email: "", phone: "", website: "", location: "", role: "", bio: "", company: "", timezone: "", language: "" },
  })
                  ...
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-semibold">Clínica Principal</span>
                        <Badge variant="outline" className="border-emerald-200 bg-emerald-50 text-emerald-700 text-xs">Activa</Badge>
                      </div>
                      <p className="text-xs text-muted-foreground">Av. Insurgentes Sur 1234, Col. Del Valle, CDMX</p>
                    </div>
                  </div>
                </AccordionTrigger>
